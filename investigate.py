...
from linling_core import SqliteKVStore, registry, Event, Scope, User, TextSegment
from linling_dsl import parse, VM
...
async def main() -> None:
    ...
    cases = [
        ...
        ("10 uni解码", find_exact("uni解码(.*)"), "uni解码\\u4f60\\u597d",
         ["\\u4f60\\u597d"], None),
        ("11 背包", find_exact("(.*)(背包|物品)(.*)"), "背包", ["", "背包", ""],
         {("啊/灵玉系/灵玉", "12345", "0"): "500",
          ("啊/禁言系/妖力", "12345", "0"): "200"}),
        ("12 查看状态 nonadmin", find_exact("查看状态"), "查看状态", [], None),
        ("13 补偿", find_exact("补偿([0-9]+)数量([0-9]+)"),
         "补偿99999数量100", ["99999", "100"], None),
        ("14 补偿蛋壳", find_exact("补偿蛋壳([0-9]+)数量([0-9]+)"),
         "补偿蛋壳99999数量50", ["99999", "50"], None),
        ("15 送锦囊给", find_exact("送锦囊给@.*"), "送锦囊给@someone", [],
         {("啊/活动系/锦囊", "12345", "0"): "1"}),
        ("16 兑换御妖符", find_exact("兑换御妖符([0-9]+)"),
         "兑换御妖符1", ["1"],
         {("啊/灵玉系/灵玉", "12345", "0"): "1000"}),
        ("17 灵玉划转X给Y", find_exact("灵玉划转([0-9]+)给([0-9]+)"),
         "灵玉划转100给99999", ["100", "99999"],
         {("啊/灵玉系/灵玉", "12345", "0"): "1000"}),
        ("18 我的灵玉", find_exact("我的灵玉"), "我的灵玉", [],
         {("啊/灵玉系/灵玉", "12345", "0"): "500"}),
        ("19 打开锦囊", find_exact("打开锦囊"), "打开锦囊", [],
         {("啊/活动系/锦囊", "12345", "0"): "1",
          ("啊/灵玉系/灵玉", "12345", "0"): "100",
          ("啊/67890/禁言卡", "12345", "0"): "0"}),
        ("20 点亮花标", find_exact("点亮花标"), "点亮花标", [],
         {("啊/活动系/玫瑰花", "12345", "0"): "3"}),
    ]
